...
import relatoriosRoutes from './modules/analytics/relatorios.routes';
import kanbanRoutes from './modules/kanban/kanban.routes';
import alertsRoutes from './modules/alerts/alerts.routes';
import aiRoutes from './modules/ai/ai.routes';
import aiAgentMonitorRoutes from './modules/ai/aiAgentMonitor.routes';
...
import enquetesRoutes from './modules/enquetes/enquetes.routes';
