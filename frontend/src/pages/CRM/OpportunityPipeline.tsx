        ...
        {pipeline.map((stage) => (
          ...
          >
            <div className="flex items-center justify-between mb-3">
              ...
              <span className="badge bg-white/80 dark:bg-slate-800/80">{stage.total}</span>
            </div>
                  ...
                  <div className="flex items-start justify-between gap-2">
                    ...
                    {canMove(opp.id) && (
                      <div className="relative">
                        ...
                        {openMenuId === opp.id && (
                          <div className="absolute right-0 top-6 z-20 bg-white dark:bg-slate-800 rounded-lg shadow-lg border border-gray-200 py-1 min-w-[140px]" onMouseLeave={() => setOpenMenuId(null)}>
                            {pipeline
